...
install_filemanager()
{
	...
	*)
	...
	filemanager_tag="$(${net_getter}  https://api.github.com/repos/tunahanertekin/filebrowser/releases/latest | grep -o '"tag_name": ".*"' | sed 's/"//g' | sed 's/tag_name: //g')"
	filemanager_url="https://github.com/tunahanertekin/filebrowser/releases/download/$filemanager_tag/$filemanager_file"
